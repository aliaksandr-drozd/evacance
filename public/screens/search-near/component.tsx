...
import { Card, FloatingPanel, Form } from 'antd-mobile'
import { useTranslation } from 'react-i18next'

import { Request } from '../../common/components'
import { ISearchInRadiusResponse } from '../../common/interfaces'


export interface ISearchNearScreenComponentProps {
  results: ISearchInRadiusResponse[]
  isSearchPending: boolean
}

export const SearchNearScreenComponent: FC<ISearchNearScreenComponentProps> = ({
  results,
  isSearchPending,
}) => {
